			...
			<div style="direction: rtl;background-color: black;"
				...
				<div class="MuiToolbar-root MuiToolbar-regular MuiToolbar-gutters">
				   ...
				   <div class="top-search" style="margin-top: 10px; margin-right: 50px;" >
					...
					<div class="jss9">
						<button
							class="MuiButtonBase-root MuiIconButton-root jss13 MuiIconButton-colorInherit"
							tabindex="0" type="button" aria-label="show more"
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					...
					<div class="social-btn">
						<a href="#" class="parent-btn"><i class="ion-heart"></i>افزودن به لیست علاقه مندی ها  </a>		
					</div>
					<div class="movie-rate">
						<div class="rate">
							<i class="ion-android-star"></i>
							<p><span>8.1</span> /10<br>
								<span class="rv">56 مشاهده</span>
							</p>
						</div>
						<div class="rate-star">
							<p>امتیاز این فیلم :   </p>
					...
					<div class="movie-tabs">
						<div class="tabs">
							<ul class="tab-links tabs-mv">
								...
								<li><a href="#reviews"> نظر سنجی کاربران</a></li>                 
							</ul>
						    <div class="tab-content">
						            ...
						            <div class="row">
						            	...
						            	<div class="col-md-8 col-sm-12 col-xs-12">
						            		...
						            		<div class="title-hd-sm">
												...
												<a href="#" class="time">همه ی 5 فیلم و 245 عکس <i class="ion-ios-arrow-right"></i></a>
											</div>
						        ...
						        <div id="reviews" class="tab review">
						           <div class="row">
						            	<div class="rv-hd">
						            		<div class="div">
							            		<h3>فیلم های مرتبط با </h3>
						       	 				<h2>طعم گیلاس</h2>
							            	</div>
							            	<a href="#" class="redbtn">نوشتن نظرسنجی</a>
						            	</div>
						            	<div class="topbar-filter">
											<p>در کل <span>56 مشاهده</span> پیدا شد</p>
											<label>جداسازی بر اساس:</label>
											<select>
												<option value="popularity">بیشترین محبوبیت</option>
												<option value="popularity">کمترین محبوبیت</option>
												<option value="rating">بیشترین امتیاز</option>
												<option value="rating">کمترین امتیاز</option>
												<option value="date">نزدیک ترین تاریخ انتشار</option>
												<option value="date">دورترین تاریخ انتشار</option>
											</select>
										</div>
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="../../public/image/uploads/userava1.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="../../public/image/uploads/userava2.jpg" alt="">
												<div>
													<h3>به خوبیه اولی بود!</h3>
													<div class="no-star">
														<i class="ion-android-star"></i>
														<i class="ion-android-star"></i>
														<i class="ion-android-star"></i>
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												<img src="../../public/image/uploads/userava3.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item ">
											<div class="user-infor">
												<img src="../../public/image/uploads/userava4.jpg" alt="">
												<div>
										...
										<div class="mv-user-review-item last">
											<div class="user-infor">
												<img src="../../public/image/uploads/userava5.jpg" alt="">
												<div>
