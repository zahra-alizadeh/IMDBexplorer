...
<head>
    ...
    <link rel="icon" href="<?php $this->asset('image/login/logo.png') ?>" type="image/x-icon">
        ...
        <nav class="navbar navbar-default navbar-custom">
            <div style="direction: rtl;background-color: black;"
                ...
                <div class="MuiToolbar-root MuiToolbar-regular MuiToolbar-gutters">
                    ...
                    <div class="jss9">
                        <button class="MuiButtonBase-root MuiIconButton-root jss13 MuiIconButton-colorInherit"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-xs-12 col-sm-12">
                                                <div class="sb-it">
                                                    ...
                                                    <p><a><?php echo $actor['first_name']; ?></a></p>
                                                </div>
                                                <div class="sb-it">
                                                    <h6> تولد تاریخ </h6>
